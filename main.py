...
if __name__ == "__main__":
    data_dir = "/Users/kq_m3m/PycharmProjects/OVAgents/ovrawm" # Replace with your actual data directory
    query = "How do I preprocess mRNA RNA-seq data using OmicVerse?"
    result = process_query(query, data_dir)
    if result:
